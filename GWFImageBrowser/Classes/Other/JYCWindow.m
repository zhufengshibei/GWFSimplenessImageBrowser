...
//        [self doBorderWidth:myBorderWidth color:nil cornerRadius:_frameWidth/2];
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(showTheButton) name:@"SHOWTHEBUTTON" object:nil];
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(hideTheButton) name:@"HIDDENTHEBUTTON" object:nil];
...
- (void)showTheButton {
    _mainImageButton.hidden = NO;
}
- (void)hideTheButton {
    _mainImageButton.hidden = YES;
}
